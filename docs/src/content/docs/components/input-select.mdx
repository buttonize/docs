   ...
   <Fragment slot="cdk">
    ...
    new ButtonizeApp(this, 'DemoApp', {
      ...
      body: [
        ...
        // since the id of the input above is "selectInput",
        // access the option's label like so
        Display.text("Selected label: {{selectInput.label}}"),
        // since the id of the input above is "selectInput",
        // access the option's value like so
...
The value in the runtime state is the string value of the select input, using dot notation to
