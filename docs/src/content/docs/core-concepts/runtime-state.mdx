...
Every `Input` [component](/core-concepts/components/#available-components) stores some relevant data in the runtime state. You can learn more in "Runtime State" section of each component.

You can access the runtime state value in your app by using [variables](/core-concepts/variables/) expressions.
