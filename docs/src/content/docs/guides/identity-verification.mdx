...
The code for this example can be found [in our examples repo](https://github.com/buttonize/examples/tree/master/identity-verification).
...
as can be seen [here](https://github.com/buttonize/examples/blob/3c0afb1bc0e9c48bd6ef0d22e487b3a0832e4975/identity-verification/bin/identity-verification.ts#L6).
