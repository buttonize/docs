...
<CardGrid>
	...
	<IntroCard title="Components" icon="open-book">
		Buttonize allow you to create internal tools composed of many different
		components. All by using AWS CDK. <br /> [Explore
		components](/core-concepts/components/#available-components).
	</IntroCard>
